...
export function PortalLinks({
  ...
  return (
    <section id="portallar" aria-labelledby="portals-title" className="scroll-mt-24 px-4 pb-20 sm:px-7 lg:px-10 lg:pb-28">
      <div className="relative mx-auto max-w-[1360px] overflow-hidden rounded-[32px] bg-navy px-6 py-14 text-white sm:px-12 lg:px-16 lg:py-20 dark:bg-[#0b2f5e]">
        ...
        <div className="relative grid gap-10 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-6">
            ...
            <p className="mt-5 max-w-[48ch] text-body-l text-white/80">{text}</p>
          </div>
