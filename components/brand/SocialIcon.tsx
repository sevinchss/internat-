...
export function SocialIcon({ id, className = "size-5" }: { id: string; className?: string }) {
  ...
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      {id === "telegram" && <path {...common} d="M21.5 4.5 2.8 11.7c-.9.4-.9 1.1 0 1.4l4.7 1.5 1.8 5.6c.2.6.4.8.9.8.4 0 .6-.2.9-.5l2.3-2.2 4.8 3.5c.9.5 1.5.2 1.7-.8l3.1-14.7c.3-1.3-.5-1.8-1.5-1.3ZM8.3 14.3l9.7-6.4" />}
      {id === "instagram" && (
        <g {...common}>
      ...
      {id === "facebook" && <path {...common} d="M14.5 8H17V4.5h-2.8C11.6 4.5 10 6.2 10 8.8V11H7.5v3.5H10V21h3.5v-6.5h2.9l.6-3.5h-3.5V9.3c0-.9.4-1.3 1-1.3Z" />}
      {id === "youtube" && (
        <g {...common}>
