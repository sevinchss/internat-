...
export default function Loading() {
  return (
    <div aria-hidden="true" className="accent-amber">
      <div className="container-x pb-20 pt-32 lg:pt-36">
        ...
        <div className="mt-16 border-t border-line lg:mt-20">
          <div className="border-l-2 border-amber/40 pl-5 pt-8 sm:ml-10 sm:pl-8 lg:ml-16 lg:pt-10">
      ...
      <div className="bg-surface py-20">
        <div className="container-x grid items-center gap-12 lg:grid-cols-12">
          <div className="mx-auto aspect-square w-full max-w-[460px] rounded-full border-[36px] border-surface-2 lg:col-span-6 lg:mx-0" />
