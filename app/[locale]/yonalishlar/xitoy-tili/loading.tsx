    ...
    <div aria-hidden="true" className="accent-red">
      <div className="container-x grid items-end gap-12 pt-32 pb-20 lg:grid-cols-12 lg:gap-10 lg:pt-36">
        ...
        <div className="mx-auto w-full max-w-[620px] lg:col-span-7 lg:mr-0">
          <div className="border-line relative aspect-square rounded-[18px] border border-dashed">
            <div className="skeleton absolute inset-[14%]" />
          </div>
      ...
      <div className="container-x border-line grid gap-12 border-t py-20 lg:grid-cols-12">
